        ...
        <div class="container">
          <div class="d-flex justify-content-between align-items-center">
            <div>
              ...
              <p class="mb-0">Your AgriConnect Dashboard</p>
            </div>
            <button (click)="logout()" class="btn btn-light text-success fw-bold px-4 rounded-pill shadow-sm">
        ...
        <div class="user-info">
          ...
          <div class="info-card">
            ...
            <div class="info-row">
              ...
              <span class="info-badge" [class]="'badge-' + currentUser?.role?.toLowerCase()">
                {{ formatUserType(currentUser?.role) }}
              </span>
            </div>
          </div>
        </div>
